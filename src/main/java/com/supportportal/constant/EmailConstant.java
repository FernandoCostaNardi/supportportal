...
public class EmailConstant {
    ...
    public static final String USERNAME = "fcostanardi@gmail.com";
    public static final String PASSWORD = "F1e0r8n0#1";
    ...
    public static final String SMTP_HOST = "mail.smpt.host";
